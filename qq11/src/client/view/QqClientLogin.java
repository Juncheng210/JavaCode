...
import client.model.QqClientUser;
...
public class QqClientLogin extends JFrame implements ActionListener{
	...
	{
		//处理北部
		jbl1=new JLabel(new ImageIcon("src/client/image/tou.gif"));
		...
		jp2_jb1=new JButton(new ImageIcon("src/client/image/clear.gif"));
		...
		//处理南部
		jp1=new JPanel();
		jp1_jb1=new JButton(new ImageIcon("src/client/image/denglu.gif"));
		//响应用户点击登录
		jp1_jb1.addActionListener(this);
		jp1_jb2=new JButton(new ImageIcon("src/client/image/quxiao.gif"));
		
		jp1_jb3=new JButton(new ImageIcon("src/client/image/xiangdao.gif"));
