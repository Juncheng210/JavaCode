...
public class ReadMessageFromServerThread implements Runnable {
	...
	public ReadMessageFromServerThread(ServerClientConnectionStream userCS, Map<String, String> userInfoMap,
			JList<String> currentOnlineUserList, MyMap isOnlineMap, MyMap isOpenMap) {
		super();
		this.userCS = userCS;
