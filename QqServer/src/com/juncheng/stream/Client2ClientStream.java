...
public class Client2ClientStream {
	...
	public Client2ClientStream(DatagramSocket userDataSocket) {
		super();
	...
	public Client2ClientStream(DatagramSocket userDataSocket, InetAddress hostAddress, int port) {
		super();
